...
def split_on_multiple_chars():
    ...
    logline = "2017-11-03T01:00:02;challenge time,regex!." "hope you join ... soon"
...
def get_all_hashtags_and_links():
    ...
    return re.findall(r"http:[a-zA-Z./-]+|#[a-zA-Z0-9]+", tweet)
...
def find_double_words():
    ...
    return re.search(r"(\b\w+\b) \1", text).group(0)
